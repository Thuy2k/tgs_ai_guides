    ...
    public static function enqueue_assets($hook)
    {
        ...
        $config = array(
            ...
            'labels' => array(
                ...
                'disableAll' => 'Tắt gợi ý toàn bộ',
                'enableAll' => 'Bật gợi ý toàn bộ',
                'disabledNotice' => 'Đã tắt gợi ý tự động trên toàn bộ trang cho tài khoản này. Bấm nút nhỏ "Bật gợi ý" khi cần dùng lại.',
                'enabledNotice' => 'Đã bật lại AI hỗ trợ hướng dẫn cho toàn bộ trang.',
                'showMoreQuestions' => 'Xem thêm',
                'showFewerQuestions' => 'Thu gọn',
